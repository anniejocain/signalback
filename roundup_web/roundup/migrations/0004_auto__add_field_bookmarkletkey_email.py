...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BookmarkletKey.email'
        db.add_column(u'roundup_bookmarkletkey', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=254, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BookmarkletKey.email'
        db.delete_column(u'roundup_bookmarkletkey', 'email')
